    ...
    const fetchAllParts = async () => {
      try {
        ...
        const transformedParts = allParts.map(part => ({
          ...
          weight: part.weight || 'Unknown', // Add weight from backend
            ...
            <div className="rounded-xl shadow-lg p-8 border border-gray-100 mb-12">
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Press Enter to search or use button below</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 ml-1">
                    Part Type
              ...
              <div className="mt-6 text-center flex gap-4 justify-center">
                <button
                  ...
                  className="bg-[#053e7f] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#08284f] transition-colors flex items-center gap-2"
                >
                  🔍 Search Parts
                </button>
                <button
                ...
                <form onSubmit={handleAddPart} className="space-y-6">
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                      ...
                      <input type="text" name="weight" value={newPart.weight} onChange={handleInputChange} placeholder="e.g. 40 lbs" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                    </div>
                  </div>
              ...
              {paginatedParts.map((part) => (
                ...
                >
                  ...
                  <div className="space-y-2 text-sm-mb-4">
                    ...
                    <p><span className="font-medium">Weight:</span> {part.weight}</p>
